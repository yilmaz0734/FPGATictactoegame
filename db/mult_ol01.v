//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=18 LPM_WIDTHB=18 LPM_WIDTHP=36 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_ol01
	...
	wire	[18:0]	wire_add12_result;
	wire	[10:0]	wire_add17_result;
	wire	[34:0]	wire_add2_result;
	wire	[26:0]	wire_add7_result;
	...
	wire	[18:0]	wire_sum_adder1aa_5dataa;
	wire	[18:0]	wire_sum_adder1aa_5datab;
	wire	[18:0]	wire_sum_adder1aa_5result;
	wire	[18:0]	wire_sum_adder1aa_6dataa;
	wire	[18:0]	wire_sum_adder1aa_6datab;
	wire	[18:0]	wire_sum_adder1aa_6result;
	wire	[18:0]	wire_sum_adder1aa_7dataa;
	wire	[18:0]	wire_sum_adder1aa_7datab;
	wire	[18:0]	wire_sum_adder1aa_7result;
	wire	[18:0]	wire_sum_adder1aa_8dataa;
	wire	[18:0]	wire_sum_adder1aa_8datab;
	wire	[18:0]	wire_sum_adder1aa_8result;
	wire  [26:0]   wire_sft10a_in;
	wire  [26:0]   wire_sft10a_out;
	wire  [26:0]   wire_sft11a_in;
	wire  [26:0]   wire_sft11a_out;
	wire  [18:0]   wire_sft13a_in;
	wire  [18:0]   wire_sft13a_out;
	wire  [18:0]   wire_sft14a_in;
	wire  [18:0]   wire_sft14a_out;
	wire  [18:0]   wire_sft15a_in;
	wire  [18:0]   wire_sft15a_out;
	wire  [18:0]   wire_sft16a_in;
	wire  [18:0]   wire_sft16a_out;
	wire  [10:0]   wire_sft18a_in;
	wire  [10:0]   wire_sft18a_out;
	wire  [10:0]   wire_sft19a_in;
	wire  [10:0]   wire_sft19a_out;
	wire  [10:0]   wire_sft20a_in;
	wire  [10:0]   wire_sft20a_out;
	wire  [10:0]   wire_sft21a_in;
	wire  [10:0]   wire_sft21a_out;
	wire  [34:0]   wire_sft3a_in;
	wire  [34:0]   wire_sft3a_out;
	wire  [34:0]   wire_sft4a_in;
	wire  [34:0]   wire_sft4a_out;
	wire  [34:0]   wire_sft5a_in;
	wire  [34:0]   wire_sft5a_out;
	wire  [34:0]   wire_sft6a_in;
	wire  [34:0]   wire_sft6a_out;
	wire  [26:0]   wire_sft8a_in;
	wire  [26:0]   wire_sft8a_out;
	wire  [26:0]   wire_sft9a_in;
	wire  [26:0]   wire_sft9a_out;
	wire  [17:0]  dataa_node;
	wire  [17:0]  datab_node;
	wire  [35:0]  final_result_node;
	wire  w480w;
	wire  [36:0]  w847w;
	wire  [323:0]  w_decoder_node9w;
	...
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[107:90]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[89:73]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[143:126]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[125:109]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[179:162]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[161:145]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {1'b0, w_decoder_node9w[215:198]},
		wire_sum_adder1aa_5datab = {{2{1'b0}}, w_decoder_node9w[197:181]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {1'b0, w_decoder_node9w[251:234]},
		wire_sum_adder1aa_6datab = {{2{1'b0}}, w_decoder_node9w[233:217]};
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7dataa + wire_sum_adder1aa_7datab;
	assign
		wire_sum_adder1aa_7dataa = {1'b0, w_decoder_node9w[287:270]},
		wire_sum_adder1aa_7datab = {{2{1'b0}}, w_decoder_node9w[269:253]};
	assign
		wire_sum_adder1aa_8result = wire_sum_adder1aa_8dataa + wire_sum_adder1aa_8datab;
	assign
		wire_sum_adder1aa_8dataa = {1'b0, w_decoder_node9w[323:306]},
		wire_sum_adder1aa_8datab = {{2{1'b0}}, w_decoder_node9w[305:289]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w480w, {w480w, {w480w, {w480w, {w_sum_node10w[118], {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {2{w480w}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w480w, {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[169], {w_sum_node10w[168], {w_sum_node10w[149], {w_sum_node10w[148], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101:100]}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w480w, {w480w, {w480w, {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w480w, {w480w, {w480w, {w480w, {w_sum_node10w[78], {w_sum_node10w[167], {w_sum_node10w[166], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w480w}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w480w, {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[165], {w_sum_node10w[164], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[141:140]}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w480w, {w480w, {w480w, {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w480w, {w480w, {w480w, {w480w, {w480w, {w_sum_node10w[163], {w_sum_node10w[162], {w_sum_node10w[161], {w_sum_node10w[160], {2{w480w}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft4a_in = {w480w, {w480w, {w480w, {w_sum_node10w[177], {w_sum_node10w[176], {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[137], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21:20]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w480w, {w480w, {w480w, {w480w, {wire_sft11a_out[26], {wire_sft11a_out[25], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft16a_out[18], {wire_sft16a_out[17], {wire_sft16a_out[16], {wire_sft16a_out[15], {wire_sft21a_out[10], {wire_sft21a_out[9], {wire_sft21a_out[8], {wire_sft21a_out[7], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[41], {w_sum_node10w[40], {2{w480w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w480w, {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w480w, {w480w, {w480w, {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[17:0]},
		datab_node = {datab[17:0]},
		final_result_node = {w847w[35:0]},
		result = {final_result_node[35:0]},
		w480w = 1'b0,
		w847w = {wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[17]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[16]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[15]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[14]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[13]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[12]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[11]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[10]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[9]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[8]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[17:0]},
		w_sum_node10w = {wire_sum_adder1aa_8result[18:0], w_decoder_node9w[288], wire_sum_adder1aa_7result[18:0], w_decoder_node9w[252], wire_sum_adder1aa_6result[18:0], w_decoder_node9w[216], wire_sum_adder1aa_5result[18:0], w_decoder_node9w[180], wire_sum_adder1aa_4result[18:0], w_decoder_node9w[144], wire_sum_adder1aa_3result[18:0], w_decoder_node9w[108], wire_sum_adder1aa_2result[18:0], w_decoder_node9w[72], wire_sum_adder1aa_1result[18:0], w_decoder_node9w[36], wire_sum_adder1aa_0result[18:0], w_decoder_node9w[0]};
endmodule //mult_ol01
//VALID FILE
